...
class ChapterApi {
  static Future<String?> parseContent(url, showDialog) async{
    return await DioManager.instance.get(url: "/parse/book/content", params: {"url": url}, showLoading: showDialog);
  }

  static Future<List<Chapter>> parseChapters(url) async{
    dynamic list = await DioManager.instance.get(url: "/parse/book/chapters", params: {"url": url});
    List<Chapter> res = [];
